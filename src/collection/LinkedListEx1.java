...
public class LinkedListEx1 {
    public static void main(String[] args) {
        Student2 st1 = new Student2("Geor", 6);
        Student2 st2 = new Student2("Artur", 5);
        Student2 st3 = new Student2("Vano", 2);
        Student2 st4 = new Student2("Miha", 3);
        Student2 st5 = new Student2("David", 6);
        ...
        Student2 st7 = new Student2("Igor", 6);
